...
<head>
    ...
    <style>
        ...
        .back-link { display: inline-block; margin-top: 15px; text-decoration: none; color: gray; }
    </style>
</head>
<body>
...
<div class="profile-container">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div style="text-align: left;">
            <label>ข้อมูลติดต่อ (เบอร์โทร, Line ID, หรือ Facebook):</label>
            <textarea name="contact_info" rows="4" placeholder="กรอกข้อมูลเพื่อให้ผู้ที่พบของสามารถติดต่อคุณได้..."><?php echo htmlspecialchars($user_data['contact_info'] ?? ''); ?></textarea>
        </div>
